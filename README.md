...
### 🚀 What I'm working on
- 🛠️ Building interactive projects with **React.js** and **Redux Toolkit**.
- 📚 Deepening my understanding of **Advanced JavaScript**.
- 🌐 Transitioning into Full Stack by mastering **Node.js, Express, and MongoDB**.
- 🎯 Seeking an **Internship / Junior Developer role** to contribute and grow.
